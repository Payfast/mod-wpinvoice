...
class wpi_payfast extends wpi_gateway_base {
  ...
  function __construct() {
    parent::__construct();    
        ...
        add_action( 'wpi_payment_fields_payfast', array( $this, 'wpi_payment_fields' ) );
    }
  ...
  function server_callback()
  {
    ...
    $pfDone = false;
    $pfData = array();
    $pfHost = ( ( $invoice->data['billing']['wpi_payfast']['settings']['test_mode']['value'] ) ? 'www' : 'sandbox' ) . '.payfast.co.za';
    $pfOrderId = '';
    $pfParamString = '';
